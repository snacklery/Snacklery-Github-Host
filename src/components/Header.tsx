      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 transition-smooth hover:scale-105">
            <img src="/images/snacklery-logo.jpeg" alt="Snacklery" className="h-10 w-10" loading="lazy" decoding="async" />
          ...
          <div className="hidden md:flex">
            <WhatsAppButton 
              ...
              variant="default" 
              className="gradient-hero text-primary-foreground shadow-green"
            >
              Get Started
            </WhatsAppButton>
          </div>
